...
\begin{itemize}
    ...
    \item $\sum_{\tau = -q}^{-1} \gamma_{\tau} D_{st}$ : leads (périodes avant traitement)
    \item $\sum_{\tau = 0}^{m} \delta_{\tau} D_{st}$ : lags (périodes après traitement)
...
\centering
\includegraphics[height=0.9\textheight, keepaspectratio]{94.png}
...
\centering
\includegraphics[height=0.9\textheight, keepaspectratio]{C3.png}
